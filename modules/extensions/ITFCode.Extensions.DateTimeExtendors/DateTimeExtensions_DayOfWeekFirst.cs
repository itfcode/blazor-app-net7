namespace ITFCode.Extensions.DateTimeExtendors
{
    ...
    public static partial class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Gets date of first Tuesday of month by input date 
        /// </summary>
        /// <param name="self">Date of Month</param>
        ...
        /// <summary>
        /// Gets date of first Wednesday of month by input date  
        /// </summary>
        /// <param name="self">Date of Month</param>
        ...
        /// <summary>
        /// Gets date of first Thursday of month by input date  
        /// </summary>
        /// <param name="self">Date of Month</param>
        ...
        /// <summary>
        /// Gets date of first Friday of month by input date
        /// </summary>
        /// <param name="self">Date of Month</param>
        ...
        /// <summary>
        /// Gets date of first Saturday of month by input date
        /// </summary>
        /// <param name="self">Date of Month</param>
        ...
        /// <summary>
        /// Gets date of first Sunday of month by input date 
        /// </summary>
        /// <param name="self">Date of Month</param>
